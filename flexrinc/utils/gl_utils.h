...
namespace flexr
{
  namespace gl_utils
  {
    ...
    static flexr::types::Frame exportGLBufferToCV(int width, int height)
    {
      ...
      flexr::types::Frame frame(height, width, CV_8UC3, pixels);
    ...
    static void makeTextureFromFrame(flexr::types::Frame *frame, GLuint &tex)
    {
    ...
    static void updateTextureFromFrame(flexr::types::Frame *frame, GLuint &tex)
    {
      glBindTexture(GL_TEXTURE_2D, tex);
