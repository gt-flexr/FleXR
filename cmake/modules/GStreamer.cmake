macro(use_gstreamer)
  ...
  if( GSTREAMER_FOUND AND GST_VIDEO_FOUND AND GST_AUDIO_FOUND )
    ...
    list(APPEND FLEXR_CXX_FLAGS ${GSTREAMER_CFLAGS_OTHER} ${GST_AUDIO_CFLAGS_OTHER} ${GST_VIDEO_CFLAGS_OTHER})
    list(APPEND FLEXR_LINKER_FLAGS ${GSTREAMER_LDFLAGS} ${GST_VIDEO_LDFLAGS} ${GST_AUDIO_LDFLAGS})
