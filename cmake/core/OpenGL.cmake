...
macro(use_opengl)
  ...
  if(OGL_FOUND)
    #list(APPEND OPENGL_INCLUDE_DIRS -I${OGL_INCLUDE_DIRS})
  ...
  if(EGL_FOUND)
    #list(APPEND OPENGL_INCLUDE_DIRS -I${EGL_INCLUDE_DIRS})
  ...
  if(GLEW_FOUND)
    #list(APPEND OPENGL_INCLUDE_DIRS -I${GLEW_INCLUDE_DIRS})
  ...
  if(GLFW_FOUND)
    #list(APPEND OPENGL_INCLUDE_DIRS -I${GLFW_INCLUDE_DIRS})
  ...
  if(GLM_FOUND)
    #list(APPEND OPENGL_INCLUDE_DIRS -I${GLM_INCLUDE_DIRS})
  ...
  message("\t OPENGL_CXX_FLAGS: ${OPENGL_CXX_FLAGS}")
  message("\t OPENGL_LDFLAGS: ${OPENGL_LDFLAGS}")

  include_directories(${OPENGL_INCLUDE_DIRS})
  list(APPEND FLEXR_CORE_CXX_FLAGS ${OPENGL_CXX_FLAGS})
  list(APPEND FLEXR_CORE_INCLUDE_DIRS ${OPENGL_INCLUDE_DIRS})
