...
int main(int argc, char const *argv[])
{
  ...
  */
  ...
  mxre::kernels::CVCamera cvCam(0, 1920, 1080);

  mxre::kernels::UnityFrameWriter unityFrameWriter(9999);
  ...
  */
  ...
  raft::map pipeline;
  //pipeline += mockCamera["out_frame"] >> unityFrameWriter["in_frame"];
  pipeline += cvCam["out_frame"] >> unityFrameWriter["in_frame"];
