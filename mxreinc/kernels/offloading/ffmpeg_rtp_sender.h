#ifndef __MXRE_FFMPEG_RTP_SENDER__
#define __MXRE_FFMPEG_RTP_SENDER__
...
namespace mxre
{
  namespace kernels
  {
    ...
    /* Class Deifinition */
    class FFmpegRTPSender : public MXREKernel
    {
      private:
      ...
      public:
        FFmpegRTPSender(std::string encoder, std::string destAddr, int destPort, int bitrate, int fps,
